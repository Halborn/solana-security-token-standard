...
pub struct InitializeVerificationConfig {
          ...
          pub config_account: solana_pubkey::Pubkey,
                /// The payer account for account creation
...
impl InitializeVerificationConfig {
  pub fn instruction(&self, args: InitializeVerificationConfigInstructionArgs) -> solana_instruction::Instruction {
...
#[inline(always)]
    pub fn system_program(&mut self, system_program: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn args(&mut self, args: InitializeVerificationConfigArgs) -> &mut Self {
        self.args = Some(args);
        self
      }
