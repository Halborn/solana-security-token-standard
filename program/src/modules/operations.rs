...
impl OperationsModule {
    ...
    pub fn execute_mint(accounts: &[AccountInfo], amount: u64) -> ProgramResult {
    ...
    pub fn execute_burn(accounts: &[AccountInfo], amount: u64) -> ProgramResult {
    ...
    pub fn execute_pause(accounts: &[AccountInfo]) -> ProgramResult {
    ...
    pub fn execute_resume(accounts: &[AccountInfo]) -> ProgramResult {
    ...
    pub fn execute_freeze_account(accounts: &[AccountInfo]) -> ProgramResult {
    ...
    pub fn execute_thaw_account(accounts: &[AccountInfo]) -> ProgramResult {
    ...
    pub fn execute_close_account(accounts: &[AccountInfo]) -> ProgramResult {
    ...
    pub fn execute_transfer(accounts: &[AccountInfo], amount: u64) -> ProgramResult {
    ...
    pub fn execute_split(accounts: &[AccountInfo], action_id: u64) -> ProgramResult {
        // TODO: Load Rate account
